...
public class Insert_patient extends JFrame {
	...
	protected static final Component Insert_patient = null;
	...
	public Insert_patient() {
		...
		ENTER.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				mp.meds=med;
				mp.disease=disease;
				boolean b1=mh.insert1(mp);
				boolean b2=mh.insert2(mp);
				boolean b3=mh.insert3(mp);
				JOptionPane.showMessageDialog(Insert_patient, "Data Successfully entered");
				PATIENT_ID.setText("");
